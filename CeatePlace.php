...
<form action="PlacesInsert.php" enctype="multipart/form-data" method="post">
  <div class="container">
    ...
    <th>
      <label>NamePlace:</label>


      <input type=text class="form-control" name="place_name" id="place_name" maxlength="50" placeholder="Name Place">
